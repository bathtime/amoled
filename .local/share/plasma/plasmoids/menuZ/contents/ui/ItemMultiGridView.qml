    ...
    Column {
        ...
        Repeater {
            ...
            delegate: Item {
                ...
                property int footerHeight: units.gridUnit // (Math.ceil(headerHeight / root.tileSide) * root.tileSide) - headerHeight
                ...
                ItemGridView {
                    ...
                    height: count ? Math.ceil(gridView.model.count/root.nColumns) * root.tileSide : 0
